...
if( gadiijuma_skaitlis % 10 == 0 ) // tiek pārbaudīts vai šis skaitlis dalās ar 10 bez atlikuma
// if( gadijuma_skaitlis % 10 == 0) // tā jūs rakstītu skolā un tas ir normāli
				    // 101 % 10 -> 1 ... 1 == 0 -> 0
				    // 100 % 10 -> 0 ... 0 == 0 -> 1
{
...
else // NB! else vienmēr pieder kādam if (if bez else var būt, else bez if nevar būt)
{
printf("Šis skaitlis dalās ar 10 bez atlikuma.\n");
